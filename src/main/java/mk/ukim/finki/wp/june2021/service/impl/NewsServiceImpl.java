...
import mk.ukim.finki.wp.june2021.repository.NewsCategoryRepository;
import mk.ukim.finki.wp.june2021.repository.NewsRepository;
...
public class NewsServiceImpl implements NewsService {
    ...
    @Override
    public News create(String name, String description, Double price, NewsType type, Long location) {
        NewsCategory newsCategory = this.newsCategoryRepository.findById(location).orElseThrow(InvalidNewsCategoryIdException::new);
        News news = new News(name,description,price,type, newsCategory);
        return this.newsRepository.save(news);
    }

    @Override
    public News update(Long id, String name, String description, Double price, NewsType type, Long location) {
